...
class PolygonsTestHelper {
  ...
  // static async uuShapesPolygonsToActiveState() {
  //   let session = await this.login("Authorities");
  //   await this.post(this.CmdList.Main.SetActive, {}, session, TestHelper._asid);
  // }
  //
  // static async uuShapesPolygonsToRestrictedState() {
  //   let session = await this.login("Authorities");
  //   await this.post(this.CmdList.Main.SetRestricted, {}, session, TestHelper._asid);
  // }
